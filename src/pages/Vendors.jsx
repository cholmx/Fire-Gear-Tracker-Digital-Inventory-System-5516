...
const {FiPlus,FiSearch,FiEdit,FiTrash2,FiPhone,FiMail,FiMapPin,FiUser,FiTool,FiGlobe}=FiIcons;
      ...
      {filteredVendors.length===0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredVendors.map((vendor)=> (
            <div key={vendor.id} className="bg-mission-bg-secondary border border-mission-border rounded-lg p-6 hover:border-mission-border-light transition-colors">
              ...
              <div className="space-y-3">
                ...
                {vendor.website && (
                  <div className="flex items-center space-x-2">
                    ...
                    <p className="text-sm font-inter text-mission-accent-blue truncate">{vendor.website}</p>
                  </div>
                )}
                {vendor.address && (
        ...
        <form onSubmit={handleAddVendor} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 bg-mission-bg-tertiary border border-mission-border rounded-lg text-mission-text-primary placeholder-mission-text-muted focus:outline-none focus:ring-2 focus:ring-fire-red focus:border-transparent font-inter"
              placeholder="e.g., NFPA certified, ISO 9001, etc."
            />
          </div>
