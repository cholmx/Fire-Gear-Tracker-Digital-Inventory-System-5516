  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-3xl font-inter-tight font-bold text-white">Stations</h1>
      ...
      {stations.length === 0 ? (
        <div className="bg-mission-bg-secondary border border-mission-border rounded-lg">
          <div className="text-center py-12">
            ...
            <p className="text-mission-text-secondary">No stations added yet</p>
            <p className="text-mission-text-muted text-sm mb-4">Add your first station to get started</p>
            <button
              onClick={() => setShowAddModal(true)}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {stations.map((station) => (
            <div key={station.id} className="bg-mission-bg-secondary border border-mission-border rounded-lg p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h3 className="text-lg font-inter-tight font-semibold text-white">
                      {station.name}
                    </h3>
              ...
              <div className="space-y-2">
                {station.address && (
                  <div className="flex items-start space-x-2">
                    ...
                    <p className="text-sm text-mission-text-secondary">{station.address}</p>
                  </div>
                )}
                {station.phone && (
                  <div className="flex items-center space-x-2">
                    <SafeIcon icon={FiPhone} className="w-4 h-4 text-mission-text-muted" />
                    <p className="text-sm text-mission-text-secondary">{station.phone}</p>
                  </div>
                )}
              </div>
